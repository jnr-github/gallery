...
class Gallery extends Component{
    ...
    render(){
        ...
        const{id,imageUrl, imageAltText}=imagesList[activeImage]
        ...
        return{
            <div className="container">
                ...
                <ul className="list-items">{imagesList.map(each=>(
                    <ThumbnailItem key={each.id} itemDetails={each} updateImage={this.updateImage} isActive={activeImage===each.id}/>
                ))}</ul>
            </div>
        }
    }
